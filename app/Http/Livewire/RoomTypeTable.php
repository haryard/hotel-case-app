...
class RoomTypeTable extends DataTableComponent
{
            ...
            ButtonGroupColumn::make('Actions')
                ...
                ->buttons([
                    LinkColumn::make('Edit')
                        ...
                        ->location(fn($row) => route('room-type.edit', ['roomType' => $row->id]))
                        ->attributes(function($row) {
                            return [
                        ...
                        ->location(fn($row) => route('room-type.destroy', ['roomType' => $row->id]))
                        ->attributes(function($row) {
                            return [
